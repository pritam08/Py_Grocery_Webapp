...
def insert_order(connection, order):
    ...
    order_query = ("INSERT INTO order_table "
...
def get_order_details(connection, order_id):
    ...
    query = "SELECT order_detail.order_id, order_detail.quantity, order_detail.total_price, "\
            "products_table.product_name, products_table.price_per_unit FROM order_detail LEFT JOIN products_table on " \
            "order_detail.product_id = products_table.product_id where order_detail.order_id = %s"
